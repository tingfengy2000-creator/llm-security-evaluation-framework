...
| GATE-S6.1-P1-PILOT4-A-B-EXECUTION | Formal Pilot4 A/B annotation execution | two independent annotators；separate randomized opaque IDs；Phase1 dual lock before Phase2；four-return lock before mapping/Expected；agreement and Owner disagreement-only adjudication | `APPROVAL_PACKET_READY / EXECUTION_NOT_APPROVED / NO_DISTRIBUTION` | Owner approves execution, assigns A/B identities and signs independence/isolation attestations | packet generation/distribution、contact、annotation、agreement、adjudication、GT before approval | 项目负责人 / PODR-087 |
...
calibration stops and Owner protocol acceptance remains pending。A/B 72 annotation、240-group、Dataset、
