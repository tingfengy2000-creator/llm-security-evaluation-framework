...
| S6.1-P1-PILOT4-PREANNOTATION | Pilot4 Signal Repair, Balanced Diagnostic Set and Pre-annotation Quality Gate | canonical lessons；field/candidate gates；structured signals；24 matched triplets / 72 candidates / 48 queries；four-round QA | all machine gates PASS；Owner workbook contains stratified 12-row sample；no human distribution | `BALANCED_DIAGNOSTIC_SET_READY_FOR_OWNER_PREFLIGHT / PREANNOTATION_ONLY` | [future dataset rules](../research/stage6_1_hidden_knowledge_poisoning/human/annotation_lessons_learned_and_future_dataset_rules.md)、PODR-071、OR-033、REL-2026-0037；Git-external manifest 22/22 | Owner preflight only；separate approval required before A/B |
