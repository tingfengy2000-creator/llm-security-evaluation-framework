...
```yaml
CURRENT_TASK: P1-FINAL72-FIVE-VIEW-SIGNAL-FEASIBILITY-EXECUTION-01
CURRENT_TASK_TYPE: LABEL_BLIND_SIGNAL_EXTRACTION / AVAILABILITY_QA / DEVELOPMENT_SET_DIAGNOSTIC
