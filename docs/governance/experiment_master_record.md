...
> 2026-09-26 Formal240 D1 HKP1 Batch-1 Phase1/Phase2 gate: first R3/R4 raw and R3 routing incident remain in `phase1_raw_lock_20260926` as historical process evidence, not the independent pair. Fresh R3/R4 raws are separately read-only in `phase1_raw_lock_fresh_r3r4_run02_20260926`, SHA256 `3488273ffa7bb8a4b0d563933b878f1dced406e1577b0f8f350d52d7f3597ef5` / `52930e9ff2e59d42565a51feda744ab92c50da6ab5e7ab0f83e9485f67c675dd`; each 30/30 schema/ID/order/enum passes and five categorical fields agree 30/30. Owner approved a one-run-only bounded equivalence for R4's new Project after current-directory inspection; platform history remains Owner-attested, not machine-proven. [Phase1 decision record](../research/stage6_1_hidden_knowledge_poisoning/formal240/PAPER1_FORMAL_D1_HKP1_BATCH1_FRESH_PHASE1_LOCK_AND_R4_ENVIRONMENT_GATE_V2.md). The Phase2 packet is ready for Owner handoff: 30 rows, 14 official Evidence docs, SHA256 `974c9348186be7ce37fe7bd11b77900f0a4f04cdedf2dd1013c2ccba8adc6991`; [release record](../research/stage6_1_hidden_knowledge_poisoning/formal240/PAPER1_FORMAL_D1_HKP1_BATCH1_PHASE2_RELEASE_RECORD_V1.md). `STOP_EXTERNAL_REVIEW_REQUIRED / PHASE2_RETURNS_NOT_RECEIVED / BATCH1_NOT_ACCEPTED / HKP2_NOT_STARTED`.

> 2026-09-26 Formal240 D1 remaining40 / HKP1 Batch-1: Owner `PODR-116` approved four sequential HKP batches, with continuation only after each complete hard-gate PASS. The first ten frozen HKP1 slots/30 candidates are locally constructed, not accepted. Private namespace `paper1_formal240_d1_remaining40_hkp1_batch1_20260926` retains 17 verified official raw snapshots, Evidence-first fact records, candidate V1–V3 history, authoritative V4 candidate JSONL SHA256 `9ae18121d78d491bd82f78c1971e9bfcd85679b1e3eecfe0123481d60ca69a00`, matching R3/R4 Phase1 package SHA256 `09dde30b0ce9aa029664107711ec32071cda8ed9363657c7c6d8251a8eef4772`, and a 93-file private index SHA256 `ccd22fbdd0da52c2adca6f8615249fec725688cc6b3423e599ac918065a4ce00`. Preliminary construction-side QA is not independent acceptance. [Public preblind record](../research/stage6_1_hidden_knowledge_poisoning/formal240/PAPER1_FORMAL_D1_HKP1_BATCH1_PREBLIND_STATUS_V1.md). `STOP_EXTERNAL_REVIEW_REQUIRED / R3_R4_PHASE1_RAW_PENDING / PHASE2_WITHHELD / HKP2_NOT_STARTED`; no Human A/B, GT, split, training or formal result.

> 2026-09-26 D1 Canary 事实原子审计追加：首次验收提交后，发现 Run02 V1 仅逐条汇总主断言，展示粒度不足；不改原证据，新增[逐断言 V2 说明](../research/stage6_1_hidden_knowledge_poisoning/formal240/PAPER1_FORMAL_D1_CANARY_FACT_ATOM_V2_SUPPLEMENT_RECORD.md)。Git-external Run03 原件只读，SHA256 `f00d10874fa581d0430b7e104f1dd6bd21c38f12f4682209029b02888762a182`；24条/48原子中40 `SUPPORTED`、8 `CONTROLLED_POISON`，显式数字/机构无未审计残留。补足审计粒度，不改变 Run02 matrix、Owner 条件式验收或下一门：剩余40组仍待另批；Human A/B、GT、split、训练仍关闭。

> 2026-09-26 Formal D1 Canary 最终质量审计：Owner 条件式接受门已在全部指定 hard gates PASS 后生效，`D1_CANARY_ACCEPTED_FOR_FULL_WAVE_CONSTRUCTION=TRUE`。8组/24条、14/14官方原始快照、R3/R4最终 Phase1/Phase2 24/24、8/8构造角色与派生S、Entity-Claim 24/24、HKP3/HKP4主机制各2/2、8条中性检索 smoke PASS。详细角色/字段/trace 在 Git-external `paper1_formal240_d1_canary_final_owner_acceptance_20260926_run02`，matrix SHA256 `9847bdc5ae4b053846007a496ca779ef35a47e99a6e1db2c073e86b65afb07ee`；[有界验收审计](../research/stage6_1_hidden_knowledge_poisoning/formal240/PAPER1_FORMAL_D1_CANARY_FINAL_OWNER_ACCEPTANCE_AUDIT_V1.md)。Run01 初稿的 host→publisher 归类过宽，保留并由 Run02 追加替代；冻结 raw 无更改。只准另行申请剩余40组构造；Human A/B、GT、split、训练和正式结果未获授权。下方“仍待验收”为此前快照。

> 2026-09-26 Formal D1 Canary V4.2 定向返回：R3-gpt/R4-codex 两份原始 15 条文件已逐字节只读锁定；各自 ID/顺序/字段/枚举/理由 15/15 合规，目标值彼此及对 Owner 语义覆盖均 15/15 一致。会话隔离为 Owner 人工证明而非机器审计。[验证及门控](../research/stage6_1_hidden_knowledge_poisoning/formal240/PAPER1_FORMAL_D1_CANARY_V4_2_TARGETED_RULE_STABILITY_REPORT_V1.md)。这是旧会话规则稳定性证据，不是新的独立标注或 GT。`VERSION_SCOPE_RULE_STABILITY_PASS / CANARY_OWNER_ACCEPTANCE_PENDING / HUMAN_AB_NOT_AUTHORIZED`；下一步 Owner 单独审查整个 Canary 并决定接受/退修，不能自动进入真人 A/B、其余40组、split 或训练。

> 2026-09-26 Formal D1 Canary V4.2：Owner `PODR-114 / OR-070` 将“候选文本本身是否提出版本命题”与“官方证据能否证明”分离；12 条裸法条实体陈述归 `NOT_PRESENT`，1 条明示修改决定归 `PRESENT_CORRECT`，2 条有冻结双版本证据支持的对照归 `LEGITIMATE_VERSION_OR_HISTORY`。15 条判断是[独立语义覆盖记录](../research/stage6_1_hidden_knowledge_poisoning/formal240/PAPER1_FORMAL_D1_CANARY_PHASE2_OWNER_SEMANTIC_ADJUDICATION_OVERLAY_V1.json)，非 R3/R4 胜负或 GT；15 条盲定向复核包待 Owner 发给原隔离会话。原答卷、Candidate、Evidence、V4/V4.1 均未改。`FORMAL_V4_2_VERSION_SCOPE_FROZEN / TARGETED_R3_R4_REREVIEW_READY / CANARY_ACCEPTANCE_PENDING / HUMAN_AB_NOT_AUTHORIZED`；下方旧解释门是历史快照。

> 2026-09-26 D1 Canary Phase2 当前门：R3-gpt 首次传输 17,199 bytes/SHA `121776bece1048be3a11c4569bfb4e0e0d48d7cbcfa422772e63a5affa0abeb5` 因引号丢失不能解析，作为真实历史原件保留；其有效重导出 18,396 bytes/SHA `29392396f705345e6213e50d5f457cc5881316ead52d706fc8d51d52024fd4fd` 与 R4-codex 原件 17,607 bytes/SHA `a1f8f4a50739d230770f7bb56920ea367a9171f1e581283105f33c9bd37c379d` 已各自锁定、24/24 结构核验通过。R3 重导出与首份传输的 ID、分类值及去界面引用后的理由正文一致，不声称原始字节相同。Owner 人工证明各自仍在原隔离会话、只用冻结 E1/E2；不是机器审计。两人 overall 22/24、version 11/24、其余六字段 24/24 一致；15 项版本/历史状态差异待 Owner 决定。[分歧门记录](../research/stage6_1_hidden_knowledge_poisoning/formal240/PAPER1_FORMAL_D1_CANARY_R3_R4_PHASE2_RAW_LOCK_AND_DISAGREEMENT_BLOCKER_V1.md)。`HUMAN_DECISION_REQUIRED / Auto Continue=NO / CANARY_ACCEPTANCE=PENDING / HUMAN_AB=NOT_AUTHORIZED`，下方 Phase2 尚未执行是上一时间点快照。

> 2026-09-26 D1 Canary Phase1 主门控收口：Owner `PODR-113 / OR-069` 指定 R3-gpt+R4-codex 为正式对、R5-claude 仅辅助。当前附件中的两段定向 JSON 按原字节切出并锁于 `paper1_formal240_d1_canary_phase1_final_closeout_20260926`：R3 622 bytes / SHA256 `15a4ac45d6e42f36d36e77fffb430a26963ed531922291c404bb5c80b63f80f9`，R4 622 bytes / SHA256 `8197616e4cc8a9dbb7007011d246a577463f6634133fb6fda2c1a4e1a981eedd`；均 2/2 ID/order/schema/enum PASS，五字段 2/2 一致。22+2 overlay 保留原24条 raw，Candidate V3 SHA `6210a6de8f519fb4a58334ff531954b67e774375d021d099dea050f8fe47032e`，Phase2 V4 SHA `2daf08286581cb8d28e70ab95ea844e5cdf41e2a6916980bf41b0a90a548ac38` 无覆盖提升为可分发。机械复核有边界；Owner 后续同步的 R5 全量24条 5,075 bytes/SHA `68e3d3cfa782d8b42b382a61c9d5a70e67fb9f1c46796dbf69b051dfd8d897ff` 和定向2条 520 bytes/SHA `0b9738c293d6873ee10cee7b12c0aadfa85a7c4a1d7b69183c08b71f2f53ad9b` 已原样锁定、验证为非门控辅助 Phase1。[收口记录](../research/stage6_1_hidden_knowledge_poisoning/formal240/PAPER1_FORMAL_D1_CANARY_PHASE1_FINAL_CLOSEOUT_V1.md)。`PHASE2_RELEASE_AUTHORIZED=TRUE / PHASE2_NOT_EXECUTED / CANARY_OWNER_ACCEPTANCE=PENDING / HUMAN_AB=NOT_AUTHORIZED`。下方旧 withheld 快照不代表当前门。

> 2026-09-23 D1 Canary R3/R4 Phase1 增量：Owner `PODR-112 / OR-068` 确认附件 1→`R4-codex`、附件 2→`R3-gpt`，并确认此前 R3 提前 Phase2 的说法是误贴、非评审事件。新 Git-external `paper1_formal240_d1_canary_r3r4_phase1_raw_lock_20260923` 锁定 R3 原件 5,661 bytes / SHA256 `323584b020cad90e382c9d7b202e20acd5ecbe2acabb0111180d6d059b44f36d`、R4 原件 6,451 bytes / SHA256 `afb0af1b61e927af61c76620f0a2ef76443c2123c07704dd7a56144a08f60e74`。两者各 24/24 ID/顺序/schema/enum PASS，五字段各 24/24 一致。隔离与无外搜是 `OWNER_ATTESTED`，非系统证实。两条共同 `MINOR_ISSUE` 引发仅固定短语的 Candidate V3，SHA256 `6210a6de8f519fb4a58334ff531954b67e774375d021d099dea050f8fe47032e`；其余 22 条及 Evidence 不变，V2 SHA 不变。两条 Phase1 定向包 ready，Phase2 V4 预建/锁哈希但 withheld；[证据索引](../research/stage6_1_hidden_knowledge_poisoning/formal240/PAPER1_FORMAL_D1_CANARY_R3_R4_PHASE1_LOCK_AND_TARGETED_REPAIR_RECORD_V1.md)。`REPAIR_ACCEPTED=FALSE / PHASE2_RELEASE_AUTHORIZED=FALSE / CANARY_ACCEPTANCE=PENDING / HUMAN_AB=NOT_AUTHORIZED`，下一步等待原 R3/R4 会话定向复核；不是 GT、正式标注或论文结果。

> 2026-09-23 D1 Canary 评审身份治理增量：Owner `PODR-111 / OR-067` 将未来 fresh pair 定为 `R3-gpt` + `R4-codex`，不重新命名旧 R1/R2 raw。Owner 本次原指令 6,430 bytes / SHA256 `e8d0111ae70cfba95d3b7ae907623d349971fff338e8d6cdbe97e18472db54f6` 原样保存在 Git-external `paper1_formal240_d1_fresh_reviewer_identity_20260923/OWNER_FRESH_REVIEWER_IDENTITY_DIRECTIVE_RAW_V1.txt`。新增[运行计划 V2](../research/stage6_1_hidden_knowledge_poisoning/formal240/PAPER1_FORMAL_D1_CANARY_R3_GPT_R4_CODEX_REVIEW_PLAN_V2.md)及独立 run attestation schema；目前新 Phase1/Phase2 原件、attestation 与有效独立 agreement 均**不存在**。两个 Phase1 原件/验证/attestation 全部通过前 Phase2 不可放行。既有 Git-external Phase2 原始 SHA 与 R1 流程失效分类不变；Canary/Human A/B/其余40组/split/training 均未获本任务批准。

> 2026-09-23 D1 Canary Phase2 流程事件：Owner `PODR-110 / OR-066` 提供一份含 R1/R2 JSON 的复合附件。整件 32,274 bytes / SHA256 `2227d5f7e988833a3ebd7b95fd11dcf72fe9fa73f5c486aa4654ff35f633d29b`，原样保存；逐字节截取的 R1 14,925 bytes / SHA256 `487bbbb7b33bc18d6af8b58fc0de968a03260483b454574d938b7dd65ab573a8`，R2 15,745 bytes / SHA256 `1a7187859ddb0fd652ddfb4eaad5add732e5f1e6731d8639eba859c2f2f40092`，均在 Git-external `paper1_formal240_d1_canary_phase2_preclarification_20260923` 锁定。各 24/24 schema/ID/order/enum PASS；R1 原文明确当前会话前阶段角色为 R2，故独立性失效。两份仅作规则澄清诊断，**无有效独立 Phase2 agreement**。前向 [V4.1](../research/stage6_1_hidden_knowledge_poisoning/formal240/PAPER1_FORMAL_ANNOTATION_GUIDE_V4_1_CLARIFICATION.md)与[事件记录](../research/stage6_1_hidden_knowledge_poisoning/formal240/PAPER1_FORMAL_D1_BLIND_REVIEW_PROCESS_INCIDENT_V1.md)保留旧原件、V4、Candidate 和 Evidence。下一门为全新 R3/R4 各 Phase1→Phase2 独立重审；Canary/Human A/B/Full48/split/training 均待批准。
...
| PILOT4-EXTERNAL-BLIND-REVIEW-PHASE-SEPARATION-01 | Pilot4 external blind Phase1/Phase2 structural separation | candidate-only Phase1, withheld Phase2, cross-phase opaque-ID parity and five-fact release gate | Phase1 leakage 0; Phase2 72 rows/144 provenance slots; release blocked pending immutable Phase1 return | `PILOT4_EXTERNAL_BLIND_PHASE1_PACKET_READY / WAITING_FOR_EXTERNAL_PHASE1_REVIEW / PHASE2_WITHHELD / NO_HUMAN_DISTRIBUTION` | `PODR-078 / OR-040 / REL-2026-0045`; Git-external `paper1_pilot4_external_blind_phase_separation_20260902`; base manifest `4c09089a...369ef`; additive manifest `3d1f850c...d05f` | Owner distributes exactly Phase1 packet + guide to a fresh isolated reviewer |
...
| PILOT4-PHASE2-FINAL-RETURN-LOCK-EXPECTED-COMPARISON-AND-PROTOCOL-ACCEPTANCE-01 | Pilot4 final Phase2 superseding lock and expected comparison | preserve first access-limited raw；lock final raw before expected；Final72 mapping unlock；Phase1/2 agreement；mismatch taxonomy；protocol recommendation | first/final raw immutable；23 access failures resolved；Phase1 exact 58/72；Phase2 exact 48/72；43 mismatches；no raw/expected rewrite | `PILOT4_FINAL_BLIND_REVIEW_COMPARISON_COMPLETE / PROTOCOL_ACCEPTANCE_RECOMMENDATION_READY / RECOMMEND_TARGETED_REPAIR / OWNER_PROTOCOL_ACCEPTANCE_PENDING / NO_AB_DISTRIBUTION` | `PODR-083 / OR-045 / REL-2026-0050`; Git-external `paper1_pilot4_phase2_final_expected_comparison_20260902` | Owner freezes primary-label boundary and decides additive targeted repair；protocol acceptance/A-B remain separate |
| PILOT4-PROTOCOL-TARGETED-REPAIR-AND-R3-VALIDATION-PACKET-01 | Pilot4 targeted protocol repair and fresh R3 packet | additive Guide V3.2；M2/M5/M8 expected adjudication；BR18 Evidence Pool repair；21 impacted + 16 matched controls；fresh opaque IDs | M2 16/16；Expected V2 changes 16；Evidence V2 changes 1；candidate changes 0；R3 37 rows；hidden-control leakage 0 | `TARGETED_REPAIR_COMPLETE / R3_VALIDATION_PACKET_READY / WAITING_FOR_FRESH_TARGETED_EXTERNAL_REVIEW / NO_AB_DISTRIBUTION` | `PODR-084 / OR-046 / REL-2026-0051`; Git-external `paper1_pilot4_protocol_targeted_repair_r3_20260902` | Owner runs a new isolated targeted R3 and returns raw CSV；protocol/A-B remain closed |
| PILOT4-R3-FINAL-RAW-LOCK-COMPARISON-AND-PROTOCOL-ACCEPTANCE-EVIDENCE-V2-01 | Pilot4 R3 final lock, Expected V2 comparison and acceptance evidence V2 | 12062-byte immutable raw；37/37 blind QA；lock-before-Expected；21 impacted + 16 controls；M2/M4/M8 and gate assessment | overall 31/37；exact 29/37；M2 3/16；controls overall 13/16；M4 PASS；M8 4/4；7 Expected defects / 6 candidates | `PILOT4_R3_VALIDATION_COMPLETE / RECOMMEND_TARGETED_REPAIR / EXPECTED_V2_SYSTEMIC_REPAIR_BLOCKER / OWNER_PROTOCOL_ACCEPTANCE_PENDING / NO_AB_DISTRIBUTION` | `PODR-085 / OR-047 / REL-2026-0052`; Git-external `paper1_pilot4_r3_final_acceptance_20260903`; raw SHA `80a10a1e...0b4441` | Owner approves/rejects additive Expected V3 correction；no R4 by default；protocol/A-B remain separate gates |
| PILOT4-EXPECTED-V3-TARGETED-CORRECTION-AND-FROZEN-GATE-RECOMPUTE-01 | Pilot4 Expected V3 evidence-supported correction and frozen gate recompute | reviewer-blind evidence/Guide audit；additive 7-field/6-candidate Expected V3；locked R3 reuse；A–F recompute | M2 3/16→2/16；root 3→2；controls overall 13/16→16/16；exact 11/16→16/16；all exact 29/37→35/37；A–F PASS | `PILOT4_EXPECTED_V3_CORRECTION_COMPLETE / PILOT4_CALIBRATION_STOP_CONDITION_MET / RECOMMEND_ACCEPT_WITH_NONBLOCKING_NOTES / OWNER_PROTOCOL_ACCEPTANCE_PENDING / NO_AB_DISTRIBUTION` | `PODR-086 / OR-048 / REL-2026-0053`; Git-external `paper1_pilot4_expected_v3_gate_recompute_20260903`; Expected V3 SHA `dc549ff6...031433` | Owner signs protocol acceptance or returns for repair；if accepted, formal A/B still requires separate approval |
| PILOT4-OWNER-PROTOCOL-ACCEPTANCE-AND-AB-EXECUTION-PREFLIGHT-01 | Pilot4 Owner protocol acceptance, calibration closure and A/B execution preflight | bind Owner acceptance；freeze Accepted Stack V1；classify residual notes；promote item-level lessons；reconstruct existing A/B contract without distribution | A–F PASS；2 nonblocking reviewer variances preserved；13 lessons promoted；Final72/Guide V3.2/Expected V3/Evidence V2 identities verified；A/B design complete | `PILOT4_ANNOTATION_PROTOCOL_ACCEPTED / PILOT4_CALIBRATION_CLOSED / PILOT4_A_B_EXECUTION_APPROVAL_PENDING / NO_AB_DISTRIBUTION / NO_GROUND_TRUTH_YET` | `PODR-087 / OR-049 / REL-2026-0054`; Git-external `paper1_pilot4_protocol_acceptance_ab_preflight_20260903` | Owner reviews A/B approval packet, assigns isolated A/B roster and approves or returns execution；no auto-run |
| PILOT4-A-B-HUMAN-ANNOTATION-USABILITY-REPAIR-01 | Pilot4 A/B human usability repair and distribution-safe V2 | preserve V1；expand human field manuals/examples/decision flow；separate read-only Packet from CSV answer sheet；prebuild Phase2 human help while withholding it | rule changes `0`；Candidate/ID/order parity 72/72；Phase1 Packet V2 exact 3 columns；Template exact 5 columns；teaching-example leakage 0；A/B normalized semantic parity true | `HUMAN_ANNOTATION_USABILITY_REPAIR_COMPLETE / BOTH_PHASE1_V2_DISTRIBUTION_READY / PHASE2_V2_PREBUILT_WITHHELD / NO_GROUND_TRUTH_YET` | `PODR-089 / OR-051 / REL-2026-0056`; Git-external `paper1_pilot4_ab_usability_repair_20260903` | Owner sends exactly each annotator's six V2 Phase1 files；do not send V1 or Phase2 |
...
| P1-FINAL72-FIVE-VIEW-SIGNAL-FEASIBILITY-EXECUTION-01 | Final72 five-view label-blind signal feasibility execution | safe projection；42-signal extraction；pre-label immutable lock；post-lock class/matched/HKP/S diagnostics；availability、redundancy、applicability and Evidence-bias QA | raw/analysis each 3024 rows；raw SHA `ab63568b...fc4fd`；analysis SHA `86a9e14b...7447d`；class 24/24/24；24 matched groups；Retrieval 720 input-missing；no training | `FINAL72_SIGNAL_FEASIBILITY_COMPLETE / READY_WITH_VIEW_LIMITATIONS` | `PODR-098 / OR-060 / REL-2026-0065`; Git-external `paper1_final72_signal_feasibility_20260915` | separately approve Retrieval-Behavior harness；no automatic Detector/scale/formal run |
| P1-RETRIEVAL-BEHAVIOR-HARNESS-AND-DEPLOYABLE-SIGNAL-BOUNDARY-01 | Retrieval harness、two-stage risk boundary and deployability audit | 24 neutral query lock；72-doc corpus lock；Sparse + frozen Dense double full traces；8448-row R lock；42-signal threat model；Temporal 72-case audit | 4 traces × 1728 rows；R SHA `eeebe7ea...c6fdef`；7104 computed / 1344 input-missing；29 oracle-only / 4 query-runtime / 7 registry-dependent / 2 not-ready | `RETRIEVAL_HARNESS_COMPLETE / DOCUMENT_DETECTOR_NOT_READY / RETRIEVAL_RISK_READY_WITH_LIMITATIONS` | `PODR-099 / OR-061 / REL-2026-0066`; Git-external `paper1_retrieval_behavior_harness_20260915` | separately approve trusted Evidence retriever + version registry prototype；no automatic Detector/scale/formal run |
| Stage 6.1 | Hidden Knowledge Poisoning Detection | 隐蔽污染检测 | LR1/R0/FU1 accepted；P1-R1 framework accepted；Pilot4 GT accepted；five-view feasibility complete with Retrieval input gap；formal result not started | `FINAL72_SIGNAL_FEASIBILITY_COMPLETE / READY_WITH_VIEW_LIMITATIONS / NOT_FORMAL_EXPERIMENT` | [长期需求](long_term_research_requirements.md) | Separately approve Retrieval-Behavior harness；no automatic model/training/scale run |
...
| GATE-S6.1-P1-PILOT4-EXTERNAL-PHASE1-RETURN | External Phase1 candidate-only return and immutable lock | fresh isolated reviewer; no web/fact lookup; exact five-column return; schema/72-ID/enum/reason/SHA256/immutability | `WAITING_FOR_EXTERNAL_PHASE1_REVIEW / PHASE2_WITHHELD` | later return-validation task may lock raw bytes; only all five facts true can release Phase2 | current release、mapping unlock、expected comparison、protocol acceptance、A/B、downstream experiment | 项目负责人 / PODR-078 |
...
| GATE-S6.1-P1-PILOT4-PROTOCOL-ACCEPTANCE | Final blind comparison and protocol acceptance | first/final raw locks；targeted R3；reviewer-blind Expected V3；frozen gates A–F；Acceptance Evidence V3 | `OWNER_ACCEPTED_WITH_NONBLOCKING_NOTES / CALIBRATION_CLOSED / R4_NOT_REQUIRED` | closed by Owner；next distinct gate is A/B execution approval | treating acceptance as A/B execution、GT、Dataset or result evidence | 项目负责人 / PODR-087 |
| GATE-S6.1-P1-PILOT4-A-B-EXECUTION | Formal Pilot4 A/B annotation execution | two independent annotators；separate randomized opaque IDs；Phase1 dual lock before Phase2；four-return lock before mapping/Expected；agreement and Owner disagreement-only adjudication | `EXECUTION_APPROVED / V1_NOT_DISTRIBUTED_AND_SUPERSEDED / BOTH_PHASE1_V2_READY / WAITING_FOR_OWNER_DISTRIBUTION / PHASE2_WITHHELD` | Owner manually sends only each annotator's six V2 Phase1 files and returns both raw CSVs for immutable lock | V1 distribution、early Phase2、mapping/Expected/agreement before four locks、GT、240-group、Dataset/Detector/Training/formal experiment | 项目负责人 / PODR-089 |
| GATE-S6.1-P1-PILOT4-TARGETED-R3 | Fresh targeted external validation after additive repair | Guide V3.2；Expected V2；Evidence Pool V2；37-row fresh opaque packet；16 matched controls；frozen snapshots | `WAITING_FOR_FRESH_TARGETED_EXTERNAL_REVIEW / NO_AB_DISTRIBUTION` | later task byte-locks complete R3 raw before mapping/Expected V2 load and produces an acceptance recommendation | Codex R3 answers、protocol acceptance、A/B、GT、240-group、Dataset freeze、Detector/Training、5090、Formal Experiment | 项目负责人 / PODR-084 |
...
diagnostic only，and Pilot4 has completed two-phase external review、targeted R3 and additive Expected V3 recomputation；A–F pass，
calibration stops、Owner protocol acceptance is complete and A/B execution is separately approved；V1 is preserved/not distributed
and superseded for distribution only；both six-file Phase1 V2 packages are ready but actual distribution is not yet recorded，while
Phase2 V2 remains withheld。A/B annotation completion、240-group、Dataset、
...
| 2026-09-02 | PILOT4 external blind Phase separation | 第 2、4、12、14、15、20 节 | 将 combined packet 追加重分类为非正式盲审工程历史；按 candidate-only Phase1、immutable return lock、withheld Phase2 实现结构隔离和五条件释放门 | [future dataset rules](../research/stage6_1_hidden_knowledge_poisoning/human/annotation_lessons_learned_and_future_dataset_rules.md)、PODR-078、OR-040、REL-2026-0045、Git-external phase-separation namespace | `WAITING_FOR_EXTERNAL_PHASE1_REVIEW / PHASE2_WITHHELD / NO_HUMAN_DISTRIBUTION`；no semantic review/acceptance/A-B/GT/freeze/training/5090/formal experiment |
| 2026-09-02 | Paper 1 mandatory documentation closeout governance | 第 2、4、12、14、20 节 | 固化每次 Paper 1 任务的 Human/Agent/Current/Execution 强制同步、conditional docs 矩阵、17-field checklist、staleness gate 与 Pilot4 验收后 lesson promotion | [closeout contract](../research/stage6_1_hidden_knowledge_poisoning/documentation_separation_contract.md)、PODR-079、OR-041、REL-2026-0046 | governance only；current Pilot4 Phase1/Phase2 gate unchanged；no external review/acceptance/A-B/GT/freeze/training/5090/formal experiment |
| 2026-09-02 | PILOT4 external Phase1 raw return lock and candidate-defect triage | 第 2、4、12、14、15、20 节 | 锁定 5001-byte raw return；验证 exact five columns、72/72 IDs、enums/reasons；记录 descriptive counts；将 5 条 issue row 提升为 blind-ID Owner triage；新增第六项 release fact | [future dataset rules](../research/stage6_1_hidden_knowledge_poisoning/human/annotation_lessons_learned_and_future_dataset_rules.md)、PODR-080、OR-042、REL-2026-0047、Git-external return-lock namespace | `OWNER_DEFECT_TRIAGE_PENDING / PHASE2_WITHHELD`；mapping/expected not loaded；no auto-fix/acceptance/A-B/GT/freeze/training/5090/formal experiment |
| 2026-09-02 | PILOT4 five-defect repair and Full72 Attempt2 preparation | 第 2、4、12、14、15、20 节 | Owner 5/5 接受 blind issue；仅解锁五项 mapping；五条 source-backed semantic-preserving repair；67 条 byte-identical；final72 + 72 new IDs/order + leakage-zero Phase1；同 corpus/IDs Phase2 rebuilt withheld；Attempt1 preserved | [future dataset rules](../research/stage6_1_hidden_knowledge_poisoning/human/annotation_lessons_learned_and_future_dataset_rules.md)、PODR-081、OR-043、REL-2026-0048、Git-external repair/Attempt2 namespace | `ATTEMPT2_PACKET_READY / FRESH_EXTERNAL_PHASE1_RETURN_PENDING / PHASE2_WITHHELD`；no review/expected/acceptance/A-B/GT/freeze/training/5090/formal experiment |
| 2026-09-02 | PILOT4 final Phase2 lock and expected comparison | 第 2、4、12、14、15、20 节 | first access-limited raw 与 final superseding raw 分别锁定；23 unreachable 全解决；raw-lock-before-expected；Final72 mapping/corpus/expected parity；Phase1 58/72、Phase2 48/72；43 mismatch taxonomy；BR-18F1D39495 evidence defect | [acceptance evidence](../research/stage6_1_hidden_knowledge_poisoning/README.md)、PODR-083、OR-045、REL-2026-0050、Git-external final-comparison namespace | `RECOMMEND_TARGETED_REPAIR / OWNER_PROTOCOL_ACCEPTANCE_PENDING / NO_AB_DISTRIBUTION`；no protocol acceptance/A-B/GT/freeze/training/5090/formal experiment |
| 2026-09-03 | PILOT4 Expected V3 and frozen gate recompute | 第 2、4、12、14、15、20 节 | Owner 批准 reviewer-blind 7-field/6-candidate additive Expected correction；Expected V3 locked before raw parse；M2 2/16、controls 16/16、exact 35/37、A–F PASS；two non-systemic residuals | [current state](current_work_state.md)、PODR-086、OR-048、REL-2026-0053、Git-external `paper1_pilot4_expected_v3_gate_recompute_20260903` | `CALIBRATION_STOP_MET / RECOMMEND_ACCEPT_WITH_NONBLOCKING_NOTES / OWNER_PROTOCOL_ACCEPTANCE_PENDING / NO_AB_DISTRIBUTION`；no protocol acceptance/A-B/GT/freeze/training/5090/formal experiment |
| 2026-09-03 | PILOT4 Owner protocol acceptance and A/B execution preflight | 第 2、4、12、14、15、20 节 | Owner 以 nonblocking notes 接受 protocol、关闭 calibration 且确认不需 R4；冻结 Accepted Stack V1；保留两条 variance；提升 13 条 evidence-supported lessons；重建 A/B execution contract | [current state](current_work_state.md)、PODR-087、OR-049、REL-2026-0054、Git-external `paper1_pilot4_protocol_acceptance_ab_preflight_20260903` | `PROTOCOL ACCEPTED / A_B EXECUTION APPROVAL PENDING / NO DISTRIBUTION / NO GT`；no A/B run、240/freeze/training/5090/formal experiment |
| 2026-09-03 | PILOT4 A/B execution approval and Phase1 packet generation | 第 2、4、12、14、15、20 节 | Owner 指定 HUMAN-A01/HUMAN-B01 两个不同真人并批准独立 A/B/Phase1 分发；各 72 新 opaque IDs 与独立顺序；两个空白五列 Phase1 包；Phase2 各 144/144 snapshot slots 预构建但封存 | [current state](current_work_state.md)、PODR-088、OR-050、REL-2026-0055、Git-external `paper1_pilot4_ab_execution_20260903` | `A_B EXECUTION APPROVED / BOTH PHASE1 PACKETS READY / WAITING OWNER DISTRIBUTION / PHASE2 WITHHELD / NO GT`；no annotation/agreement/freeze/training/5090/formal experiment |
| 2026-09-03 | PILOT4 A/B human annotation usability repair | 第 2、4、12、14、15、20 节 | Owner 在真实分发前识别 V1 的人类可用性缺口；V1 原样保留且未分发；增加详细字段手册、Quick Reference、六个完整示例、常见错误、三列只读 Packet、五列 CSV 模板与 Phase2 V2 人类说明 | [current state](current_work_state.md)、PODR-089、OR-051、REL-2026-0056、Git-external `paper1_pilot4_ab_usability_repair_20260903` | `RULE CHANGE 0 / CANDIDATE-ID-ORDER PARITY / BOTH PHASE1 V2 READY / PHASE2 V2 WITHHELD / NO GT`；next only Owner six-file V2 distribution |
