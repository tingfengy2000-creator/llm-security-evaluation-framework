...
提交后发现 Run02 的事实原子表呈现粒度不足，已[追加 V2 逐断言核对](docs/research/stage6_1_hidden_knowledge_poisoning/formal240/PAPER1_FORMAL_D1_CANARY_FACT_ATOM_V2_SUPPLEMENT_RECORD.md)：24条共48个带来源定位的原子，40个受支持、8个受控错误，未发现额外错误或歧义。原 Run02 保留；验收范围和下一审批门不变。
