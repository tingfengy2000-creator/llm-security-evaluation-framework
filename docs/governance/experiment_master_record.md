...
| 当前任务 | `S6.1-R0-FU1-W2-H2-RESUME-02 = CONTROL_PLANE_REVIEW_PASS / ENGINEERING_SMOKE_EVIDENCE_ACCEPTED`；resume_01 remains immutable。 |
| 当前审批门 | H2 evidence review complete；project-owner decision required for parent W2；no second H2-B call or automatic P1。 |
...
| 当前主要阻塞项 | `BLK-S6.1-FU1-W2-001` resolved for the exact minimal feasibility gate；parent W2 awaits owner disposition；formal-environment, historical generation identity and redistribution items remain separate。 |
| 当前允许宣称 | resume_01 valid fail-closed history；resume_02 exact engineering-smoke evidence accepted；H2-B executed once/call_count one；no local Control Plane model execution。 |
| 当前禁止宣称 | GMTP reproduction/effectiveness/safety/generalization、W2 completed/accepted、P1/formal experiment or paper result。 |
...
| S6.1-R0-FU1-W2-H1 | Offline Model Artifact Provisioning and W2 Resume | exact-revision offline bundle without LOCAL model loading | artifacts prepared locally；identity/index/load verified within frozen H2 on 5090 | `OFFLINE_MODEL_ARTIFACTS_VERIFIED_ON_5090` | [H2 resume02 review](../research/stage6_1_hidden_knowledge_poisoning/s6_1_r0_fu1_w2_h2_resume02_control_plane_review.md)、REL-2026-0023 | complete dependency；no new model authority |
| S6.1-R0-FU1-W2-H2 | Offline Model Bundle Verification and Conditional GMTP Detection-Core Resume | 5090 verifies exact offline bundle, then conditionally makes one frozen two-document call | resume_01 valid blocked；resume_02 H2-A/H2-B evidence reviewed | `ENGINEERING_SMOKE_COMPLETED / CONTROL_PLANE_REVIEW_PASS` | [H2 resume02 review](../research/stage6_1_hidden_knowledge_poisoning/s6_1_r0_fu1_w2_h2_resume02_control_plane_review.md)、REL-2026-0023 | parent W2 owner decision；no rerun or automatic P1 |
...
| BLK-S6.1-FU1-W2-001 | 2026-07-31 | Stage 6.1 | FU1-W2 | RTX5090 | high | exact GMTP detector core/models/scores were unvalidated on modern Worker environment | P1 lacked executable detector baseline feasibility evidence | W2 engineering validation | hardened exact source/input/model/config/environment/resource contract；resume02 archive `58da856a...f563` | H2-A `18/18` and indexed `25/25` pass；exact local CUDA models；one redacted two-document call | Control Plane accepted exact minimal feasibility evidence | engineering-smoke gate complete | parent W2 owner disposition pending | no reproduction/effectiveness/P1 inference | RESOLVED_BY_H2_RESUME02_CONTROL_PLANE_REVIEW | PENDING_THIS_COMMIT | RUN-H2-R02 | 2026-08-01 | RESOLVED |
...
| BLK-S6.1-LR1-001 | 2026-07-31 | strict comparison 准入 | high | Paper 1 strict comparison | `OPEN` | [Artifact Registry](../research/stage6_1_hidden_knowledge_poisoning/external_artifact_registry.md)、accepted R0/FU1-P0/L1 | source artifact identity improved；internal research, strict comparison and redistribution remain separate | accepted W2 plus later P1/formal protocol/environment | await W2 owner decision |
...
| BLK-S6.1-FU1-W2-001 | 2026-07-31 | Worker validation | high | GMTP executable core | `RESOLVED` | resume02 SHA/safe/index `25/25`, H2-A `18/18`, exact models/source/input/environment, one CUDA call and redacted resources/results | engineering-smoke evidence only；parent W2 not accepted | `RESOLVED_BY_H2_RESUME02_CONTROL_PLANE_REVIEW` | owner decides parent W2 |
| W2_ATTEMPT1_EVIDENCE_BLOCKER | 2026-08-01 | evidence completeness | high | Attempt 1 classification / H1 start | `RESOLVED` | Correction 02 SHA/safe/index `17/17`, exact GNU `du` commands/raw streams, resource/no-mutation and materiality `11/11` pass | preserve earlier fail-closed history；do not infer runtime facts | `RESOLVED_BY_CORRECTION_02_CONTROL_PLANE_REVIEW` | H1 prepared；parent W2 gate remains open |
...
| GATE-S6.1-R0-FU1-W2-H1 | Offline Model Artifact Provisioning and W2 Resume | exact snapshots, 17 model files, 19-entry index, 2 GiB gate, safe bundle and sidecar | `OFFLINE_MODEL_ARTIFACTS_VERIFIED_ON_5090` | completed as dependency of accepted H2 smoke evidence | automatic new model use、W2 acceptance、P1 | 项目负责人 |
| GATE-S6.1-R0-FU1-W2-H2 | Offline bundle verification and conditional detection-core resume | H2-A `18/18`; frozen environment/offline local model load; exactly one fixed call; archive/index `25/25` | `ENGINEERING_SMOKE_COMPLETED / CONTROL_PLANE_REVIEW_PASS` | owner may decide parent W2 disposition | retry/rerun/mutation/network、W2 acceptance、P1/formal claims | Control Plane reviewed；项目负责人 next |
| GATE-S6.1-R0-FU1-W2-H2-RESUME-02 | Additive evidence namespace rollover | resume_01 unchanged；resume02 archive SHA `58da856a...f563`; safe members；index `25/25`; H2-A/H2-B/resource evidence | `CONTROL_PLANE_REVIEW_PASS / ENGINEERING_SMOKE_EVIDENCE_ACCEPTED` | parent W2 owner decision | second call、resume_03、reproduction/effectiveness/P1 claims | Control Plane |
