...
| 当前任务 | `S6.1-R0-FU1-W2-ATTEMPT1-CORRECTION-02 = APPROVED_TO_START / NOT SENT / NOT EXECUTED` on `RTX5090 / COMPUTE_WORKER`。 |
| 当前审批门 | Worker pulls the exact approval commit and returns only indexed GNU `du` provenance evidence for separate Control Plane review；`FORMAL_EXPERIMENT = NOT STARTED`。 |
| 下一批准任务 | none automatically；after returned evidence LOCAL applies `MATERIALITY_AND_FINAL_CLOSURE_RULE`；H1 remains approved but blocker-gated；S6.1-P1 remains closed。 |
...
| 当前允许宣称 | PO-MHEP remains permanent highest internal execution authority；Correction 02 is owner-approved but not sent/executed；existing Correction 01/W2 evidence facts remain unchanged。 |
| 当前禁止宣称 | Correction 02 sent/executed/accepted、`ENV_DISK_CONTRACT` accepted、Attempt 1 valid blocked run/reusable preflight、H1 started/models prepared、W2 result、P1/formal experiment or security effectiveness。 |
...
| S6.1-R0-FU1-W2-ATTEMPT1-CORRECTION-02 | W2 Attempt 1 GNU du Provenance Final Evidence Correction | exact apparent/allocated `du` commands, tool/Conda/time provenance, raw streams/exits, counts and indexed manifest | owner-approved；not sent/executed；blocker still open | `EVIDENCE_PACKAGING_CORRECTION_APPROVED` | [FU1 resolution](../research/stage6_1_hidden_knowledge_poisoning/s6_1_r0_fu1_targeted_resolution.md)、PODR-057、REL-2026-0018 | RTX5090 exact-commit execution then Control Plane review |
...
| W2_ATTEMPT1_EVIDENCE_BLOCKER | 2026-08-01 | Stage 6.1 | FU1-W2 Attempt 1 review | LOCAL + RTX5090 | high | original archive omitted repository/disk capture；Correction 01 omits exact `du` commands/flags/raw outputs needed to distinguish apparent from allocated bytes | Attempt 1 cannot be accepted or reused；H1 cannot start | Attempt 1 classification and H1 recovery gate | original `6acdbb...170f`；correction `d911063e...5279e`；[review](../research/stage6_1_hidden_knowledge_poisoning/s6_1_r0_fu1_w2_attempt1_control_plane_review.md) | verify both indexed archives and cross-check manifest/text | original partial facts passed；repository/disk evidence absent | correction safe `6/6`, index `4/4`, original binding/main repo pass；disk values consistent but command provenance absent | request command-derived additive correction only | H1 download/bundle prohibited while open | NOT_RECORDED | PENDING_THIS_COMMIT | N/A | NOT_RECORDED | OPEN |
...
| W2_ATTEMPT1_EVIDENCE_BLOCKER | 2026-08-01 | evidence completeness | high | Attempt 1 classification / H1 start | `OPEN` | Correction 01 SHA/safe/index/original binding/main repo pass；disk values consistent；exact `du` commands/flags/raw outputs absent | no summary inference；no H1 download | command-derived indexed evidence | await minimal measurement correction |
...
| GATE-S6.1-R0-FU1-W2-CORRECTION-02 | Command-derived disk measurement evidence | exact GNU `du`/tool/Conda/time/count/index contract plus final materiality rule | `APPROVED_TO_START / NOT SENT / NOT EXECUTED` | RTX5090 pulls exact approval commit and executes evidence-only contract | LOCAL execution/contact、H1、GMTP、environment mutation、P1/formal experiment | RTX5090 executes；Control Plane reviews |
