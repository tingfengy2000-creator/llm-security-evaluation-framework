...
| 当前主要阻塞项 | Pilot4 hardened Schema V3.1 Owner acceptance pending；机器未建立两个独立 reviewer；formal protocol numeric parameters、Scale Pilot、Dataset 和 method effectiveness 均未冻结。 |
| 当前允许宣称 | Pilot4 b705cc history 保留；新增候选版本通过 72/72 单次 label-blind review、lock-before-compare、validator 与 workbook QA；不代表独立人工接受、Ground Truth 或 Detector effectiveness。 |
