# D1 Canary blind quality review — R3 Phase1

You are reviewer R3 in a fresh, independent session. Work alone. Do not inspect a repository, other reviewers' work, coordinator notes, mappings, expected answers, later-phase evidence, or any external source. Do not ask another AI assistant. This is pre-annotation quality review, not Ground Truth annotation.
