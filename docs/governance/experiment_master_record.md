...
| 当前任务 | `S6.1-R0-FU1-W2-H2-RESUME-02 = APPROVED_TO_START / NOT EXECUTED`；resume_01 valid blocker evidence is immutable。 |
| 当前审批门 | preserve resume_01；fresh resume_02 H2-A complete pass -> exactly one still-unused H2-B call；completion/blocker -> 本机 review。 |
...
| 当前允许宣称 | resume_01 valid fail-closed evidence/index；bundle/sidecar outer size/SHA owner-confirmed on 5090；resume_02 additive namespace approved；H2-B not executed/call_count zero。 |
| 当前禁止宣称 | complete H2-A/model index/load verified、GMTP compatibility/scores/runtime、W2 completed/accepted、P1/formal experiment or security effectiveness。 |
...
| S6.1-R0-FU1-W2-H2 | Offline Model Bundle Verification and Conditional GMTP Detection-Core Resume | 5090 verifies exact offline bundle, then conditionally makes one frozen two-document call | resume_01 valid blocked；resume_02 approved；H2-B not executed | `IN_PROGRESS / RESUME_02 APPROVED / H2-B NOT EXECUTED` | [FU1 work process](../research/stage6_1_hidden_knowledge_poisoning/stage_process/S6.1-R0-FU1_work_process.md)、PODR-059/060、REL-2026-0021/0022 | fresh H2-A complete pass before H2-B；stop and return to 本机 |
...
| S6.1-R0-FU1-W2-H2-RESUME-02 | Additive Evidence Namespace Rollover | preserve resume_01 and rerun full H2-A in new namespace | approved；not executed | `APPROVED_TO_START / NOT EXECUTED` | [FU1 work process](../research/stage6_1_hidden_knowledge_poisoning/stage_process/S6.1-R0-FU1_work_process.md)、PODR-060、REL-2026-0022 | complete H2-A before still-unused one H2-B call |
...
| GATE-S6.1-R0-FU1-W2-H2 | Offline bundle verification and conditional detection-core resume | H2-A 18-item bundle gate, frozen environment/offline mode, then exactly one fixed two-document call and redacted indexed evidence | `IN_PROGRESS / RESUME_02 APPROVED / H2-B NOT EXECUTED` | resume_02 H2-A pass permits H2-B once | H2-B before H2-A、retry/repair/mutation/network、W2 acceptance、P1/formal claims | 项目负责人 |
| GATE-S6.1-R0-FU1-W2-H2-RESUME-02 | Additive evidence namespace rollover | resume_01 immutable；resume_02 absent/empty；new resume02 archive；all scientific/runtime contracts unchanged | `APPROVED_TO_START / NOT EXECUTED` | fresh H2-A；only full pass permits unused H2-B call | overwrite/delete resume_01、nonempty resume_02、automatic resume_03、contract drift | 项目负责人 |
...
the historical evidence blocker is resolved；H1 artifacts are prepared；H2 resume_01 is valid blocked evidence with H2-B not
executed/call_count zero；bundle/sidecar are now owner-confirmed synchronized；resume_02 is `APPROVED_TO_START / NOT EXECUTED`
with conditional continuation only inside H2。S6.1-P1、Dataset、Detector、
