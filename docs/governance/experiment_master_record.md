...
| 当前任务 | `PILOT4-EVIDENCE-POOL-REPAIR-01 = EVIDENCE_POOL_REPAIR_AND_SCHEMA_V3_1_FINALIZATION`。 |
| 当前审批门 | Owner reviews V3.1 final review、three workbooks、23 companion source records and full72/validator QA；不得推断 A/B distribution。 |
...
| 当前主要阻塞项 | Pilot4 Schema V3.1 Owner acceptance pending；formal protocol numeric parameters、Scale Pilot、Dataset 和 method effectiveness 均未冻结。 |
| 当前允许宣称 | Pilot4 72-candidate corpus 未变；Evidence Pool duplicate-slot blocker 已从 55/72 candidates、23 triplets 修复为 0/72，Schema V3.1/full72/validator/workbook QA PASS；不代表人工接受、Ground Truth 或 Detector effectiveness。 |
