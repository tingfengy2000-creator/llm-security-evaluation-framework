...
```yaml
CURRENT_TASK: PILOT4-A-B-DUAL-PHASE2-RAW-LOCK-AND-AGREEMENT-PREFLIGHT-01
CURRENT_TASK_TYPE: IMMUTABLE_DUAL_PHASE2_RAW_LOCK / AB_AGREEMENT_PREFLIGHT / OWNER_DECISION_GATE
...
S6.1-P1: PILOT4_AB_ALL_FOUR_RAWS_LOCKED / DUAL_PHASE2_LOCK_GATE_PASS / AB_AGREEMENT_PREFLIGHT_COMPUTED / OWNER_ADJUDICATION_PENDING / HUMAN_DECISION_REQUIRED / EXPECTED_V3_NOT_LOADED / NO_GROUND_TRUTH_YET
...
PILOT4_OWNER_ADJUDICATION: PENDING / HUMAN_DECISION_REQUIRED
