...
task_execution_base_commit: 7a8702c533738d0f9c641d45593c9a76b92bdf0f
...
```yaml
CURRENT_TASK: PILOT4-A-B-OWNER-ADJUDICATION-CONSISTENCY-CLOSURE-01
CURRENT_TASK_TYPE: ADDITIVE_OWNER_CORRECTION_INGESTION / FULL_CANDIDATE_VIEW_VALIDATION
...
S6.1-P1: PILOT4_AB_ALL_FOUR_RAWS_LOCKED / OWNER_ADJUDICATION_RETURN_RAW_LOCKED / OWNER_ADJUDICATION_CONSISTENCY_CLOSED / UNRESOLVED_CONSISTENCY_BLOCKER_0 / EXPECTED_V3_NOT_LOADED / NO_GROUND_TRUTH_YET / WAITING_FOR_OWNER_NEXT_APPROVAL
...
PILOT4_GROUND_TRUTH_CREATED: FALSE
